...
Configuration in this directory creates IAM roles that can be assumed by multiple SPIFFE trust domains as well as EKS `ServiceAccount`s for various tasks.

# Usage

To run this example you need to replace the `locals.trust_domain_arn` with the ARN of the SPIFFE trust domain you want to use.
